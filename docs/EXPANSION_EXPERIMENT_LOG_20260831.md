...
| E5 | ICEWS05-15 | temporal DistMult | uniform | 0, .3 | Completed; negative-sampling sensitivity on added dataset |
| E6 | ICEWS14 | continuous-time ComplEx | uniform | 0, .3 | Completed; negative-sampling sensitivity on added scorer |
...
| 2026-09-01 | Completed and audited formal E1 | commit `52beca5`; config SHA-256 `b8159bc51883a7ddc1d0ef1d362605d278c2966ec9c73e746780273b912c8f62` | `results/expansion_formal/icews14_distmult_filtered/20260831T183333122638Z-7584b3c257f7` | Run-manifest SHA-256 `6e0374236d2b8f65d148c47bc83be46acbd08cec34f089b77e24e2372c1003a4`; all 20 condition markers present | E1 completed in 6,682.52 s. Audit found 11,680 window rows, 8 expected methods, 2,315,760 inspected query rows, answer counts from 1 to 17, 484,260 multi-answer label rows, finite coverage/set-size/MRR values, and zero prequential leakage violations. No result interpretation was promoted to the manuscript. |
| 2026-09-01 | Validated post-matrix analysis and bootstrap exporters on the complete E1 schema | analysis commit `356dee7`; bootstrap commit `7fec5c4`; source run commit `52beca5` | isolated output `/root/autodl-tmp/e1_postprocess_validation`; formal worktree unchanged | Analysis and bootstrap `SHA256SUMS.txt` both passed in full | Analysis exporter produced 9 declared output entries. A 1,000-iteration, block-length-7 schema validation produced 13 predeclared bootstrap statistics from the real E1 query artifacts. This was a tooling validation only; final estimates require the complete E1-E6 matrix and the frozen 20,000-iteration, four-block-length run. |
| 2026-09-01 | Formal matrix advanced to E3 | commit `52beca5`; config SHA-256 `1533ec683c34ee7e556c4b0be7761e8549288f72f654799a0718b82a8c693160` | formal PID `11314`; `icews14_tcomplex_filtered` | Atomic progress status `running`; one E3 condition marker present at the check | Process remained alive at about 645% CPU with low memory. The instantaneous GPU process query reported 0 MiB while CPU-side scoring/calibration was active; no failure or retry appeared in the log, so the run was not interrupted. |
| 2026-09-01 | Added and server-validated checksum-gated expansion figure generation | commit `11cb553`; script SHA-256 `440d7d1c4f04004d9c583ce4c92de67c74d279b462da21d4a0e04b45362e785f`; test SHA-256 `70b3d8300e7cf7989558fafb5922c90d2e6198d7ef24a05ff595d8225add5ec3` | isolated staging `/root/autodl-tmp/riskcal_expansion_staging_v5`; formal worktree unchanged | Local and server file hashes matched; focused tests `2 passed`; full suite `121 passed` with the same pre-existing trusted-checkpoint warning | Generator refuses untracked or checksum-mismatched analysis inputs and creates cross-dataset/model coverage, reviewer-diagnostic, and multi-answer PDF/PNG figures plus a manifest and checksums. No final figure or manuscript edit was produced before E1-E6 completion. |
| 2026-09-01 | Added and server-validated a fail-closed public-release audit | commit `d53badd`; transfer archive SHA-256 `d7b4fad78e94f77236cc99d9e66a90af3d2e59416cc281d868e6ceb4f76b513c` | isolated staging `/root/autodl-tmp/riskcal_expansion_staging_v5`; formal worktree unchanged | Transfer checksum matched; focused tests `2 passed`; full suite `123 passed` with the same pre-existing trusted-checkpoint warning | Audit requires complete E1-E6 manifests and markers, exact config/run hashes, frozen 20,000-iteration bootstrap with block lengths 3/7/14/21, checksum-bound figures, a clean Git worktree, tracked publication files, and matrix-commit ancestry. It will be executed on the final clean clone before release/tag creation. |
| 2026-09-01 | Completed and audited formal E3 | commit `52beca5`; config SHA-256 `1533ec683c34ee7e556c4b0be7761e8549288f72f654799a0718b82a8c693160` | `results/expansion_formal/icews14_tcomplex_filtered/20260831T202456266777Z-219d03258eac` | Run-manifest SHA-256 `36ae8a6c3434c2a7c3fadeae51db0180f321dad55cd5140d5828505b0fe94ea0`; all 20 condition markers present | E3 completed in 8,667.80 s. Audit found 11,680 window rows and 2,315,760 query rows, 8 expected methods, model identity `continuous_tcomplex`, filtered sampling, answer counts from 1 to 17, 484,260 multi-answer label rows, finite coverage/set-size/MRR values, and zero prequential leakage violations. No paper interpretation was entered. |
...
| 2026-09-02 | Completed and audited formal E5 | commit `52beca5`; config SHA-256 `937385bfafc28ead17a627a50aef774fea4f06908cb9d4b2fb50c7115228924e` | `results/expansion_formal/icews05_15_distmult_uniform_sensitivity/20260901T170951980802Z-4a0151ce4650` | Run-manifest SHA-256 `7a1be1cdac310ae61c7542f7da84b45ed81c56ddac71d23423e6528861cb6ab4`; external structure-audit SHA-256 `62d49d0a8784180f3652777995d253bc106f3dec012b99996d6d17c31fbe8b3a`; all 10 condition markers present | E5 completed in 17,399.79 s. Audit found 64,320 window rows, 5,709,300 query rows, 10 checkpoints and resource records, 8 expected methods, model identity `temporal_distmult`, uniform sampling, answer counts from 1 to 12, 911,850 multi-answer label rows, set sizes from 1 to 10,488, zero inconsistent multiplicity groups, finite core metrics, and zero prequential leakage violations. The E2/E5 structural supports match; effect estimation remains deferred to the frozen post-matrix bootstrap. |
| 2026-09-02 | Formal matrix advanced to E6 | commit `52beca5`; frozen `icews14_tcomplex_uniform_sensitivity.yaml` | formal PID `11314`; `icews14_tcomplex_uniform_sensitivity` | Atomic progress status `running`; cumulative matrix count 80 of 90 at transition | The controller advanced automatically after E5. No configuration, seed, or output path was changed during the transition. |
| 2026-09-02 | Completed and audited formal E6 | commit `52beca5`; config SHA-256 `d0c954d78655da49949dfe953986fd75718b259a484d11fa48c6cfe46fc995d6` | `results/expansion_formal/icews14_tcomplex_uniform_sensitivity/20260901T215952569118Z-936518147fc8` | Run-manifest SHA-256 `8b1567858abbd8e414812cc92dc27056921d55290d01b6f0dac025a415aa6ad8`; external structure-audit SHA-256 `7c770f0ae281432e8dfc386f054e41392547a427b8e88a58b5e024a1395bce0e`; all 10 condition markers present | E6 completed in 3,566.36 s. Audit found 5,840 window rows, 1,157,880 query rows, 10 checkpoints and resource records, 8 expected methods, model identity `continuous_tcomplex`, uniform sampling, answer counts from 1 to 17, 242,130 multi-answer label rows, set sizes from 1 to 7,128, zero inconsistent multiplicity groups, finite core metrics, and zero prequential leakage violations. The E3/E6 structural supports match. |
| 2026-09-02 | Frozen formal E1-E6 matrix completed | commit `52beca5`; six immutable config hashes recorded in atomic progress | `results/expansion_formal` | Six run-manifest hashes recorded; external audits E2/E4/E5/E6 and prior E1/E3 checks passed | The single controller process exited normally after 90 of 90 conditions. Across the six runs there are 286,480 window rows and 28,626,600 inspected query rows, including 4,858,050 multi-answer label rows. No condition was manually relaunched. Manuscript remains locked pending final analysis, bootstrap, figures, and release audit. |
